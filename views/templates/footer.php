...
Este archivo representa el pie de página del sitio DevWebCamp.
  ...
  <div class="footer__grid">
    <div class="footer__contenido">
      ...
      <p class="footer__texto">
        DevWebCamp es una conferencia para desarrolladores de todos los niveles, y se lleva a cabo de forma presencial y
        en linea.
      </p>
    </div>
